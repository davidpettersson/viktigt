...
#
# Generated Tue Jul 18 00:51:59 2017 by generateDS.py version 2.28a.
#
# Command line options:
#   ('-o', '../../Projects/smhi/cap_api.py')
#
# Command line arguments:
#   ../../Projects/smhi/schemas/CAP-v1.2.xsd
#
# Command line:
#   ./generateDS.py -o "../../Projects/smhi/cap_api.py" ../../Projects/smhi/schemas/CAP-v1.2.xsd
#
...
class alert(GeneratedsSuper):
    ...
    def __init__(self, identifier=None, sender=None, sent=None, status=None, msgType=None, source=None, scope=None, restriction=None, addresses=None, code=None, note=None, references=None, incidents=None, info=None, anytypeobjs_=None):
        ...
        self.sender = sender
        if isinstance(sent, BaseStrType_):
    ...
    def export(self, outfile, level, namespace_='cap:', name_='alert', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2" xmlns:xs="http://www.w3.org/2001/XMLSchema" ', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('alert')
    ...
    def exportChildren(self, outfile, level, namespace_='cap:', name_='alert', fromsubclass_=False, pretty_print=True):
        ...
        if self.sender is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssender>%s</%ssender>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.sender), input_name='sender')), namespace_, eol_))
        ...
        if self.msgType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smsgType>%s</%smsgType>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.msgType), input_name='msgType')), namespace_, eol_))
        ...
        if self.scope is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sscope>%s</%sscope>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.scope), input_name='scope')), namespace_, eol_))
        if self.restriction is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srestriction>%s</%srestriction>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.restriction), input_name='restriction')), namespace_, eol_))
        if self.addresses is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saddresses>%s</%saddresses>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.addresses), input_name='addresses')), namespace_, eol_))
        for code_ in self.code:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scode>%s</%scode>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(code_), input_name='code')), namespace_, eol_))
        ...
        if self.incidents is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sincidents>%s</%sincidents>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.incidents), input_name='incidents')), namespace_, eol_))
...
class sent(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='cap:', name_='sent', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('sent')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
class info(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='cap:', name_='info', fromsubclass_=False, pretty_print=True):
        ...
        if self.event is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sevent>%s</%sevent>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.event), input_name='event')), namespace_, eol_))
        for responseType_ in self.responseType:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sresponseType>%s</%sresponseType>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(responseType_), input_name='responseType')), namespace_, eol_))
        if self.urgency is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%surgency>%s</%surgency>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.urgency), input_name='urgency')), namespace_, eol_))
        ...
        if self.certainty is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scertainty>%s</%scertainty>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.certainty), input_name='certainty')), namespace_, eol_))
        if self.audience is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saudience>%s</%saudience>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.audience), input_name='audience')), namespace_, eol_))
        ...
        if self.senderName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssenderName>%s</%ssenderName>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.senderName), input_name='senderName')), namespace_, eol_))
        if self.headline is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sheadline>%s</%sheadline>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.headline), input_name='headline')), namespace_, eol_))
        ...
        if self.instruction is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sinstruction>%s</%sinstruction>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.instruction), input_name='instruction')), namespace_, eol_))
        if self.web is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sweb>%s</%sweb>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.web), input_name='web')), namespace_, eol_))
        if self.contact is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scontact>%s</%scontact>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.contact), input_name='contact')), namespace_, eol_))
...
class urgency(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, urgency)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if urgency.subclass:
    ...
    def export(self, outfile, level, namespace_='cap:', name_='urgency', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('urgency')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
class severity(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, severity)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='cap:', name_='severity', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('severity')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
class certainty(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, certainty)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='cap:', name_='certainty', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('certainty')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
class eventCode(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eventCode)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='cap:', name_='eventCode', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eventCode')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
    ...
    def exportChildren(self, outfile, level, namespace_='cap:', name_='eventCode', fromsubclass_=False, pretty_print=True):
        ...
        if self.valueName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svalueName>%s</%svalueName>%s' % ('cap:', self.gds_encode(self.gds_format_string(quote_xml(self.valueName), input_name='valueName')), 'cap:', eol_))
        if self.value is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svalue>%s</%svalue>%s' % ('cap:', self.gds_encode(self.gds_format_string(quote_xml(self.value), input_name='value')), 'cap:', eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class effective(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, effective)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='cap:', name_='effective', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('effective')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
class onset(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='cap:', name_='onset', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('onset')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
class expires(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, expires)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if expires.subclass:
    ...
    def export(self, outfile, level, namespace_='cap:', name_='expires', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('expires')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
class resource(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='cap:', name_='resource', fromsubclass_=False, pretty_print=True):
        ...
        if self.resourceDesc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sresourceDesc>%s</%sresourceDesc>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.resourceDesc), input_name='resourceDesc')), namespace_, eol_))
        ...
        if self.derefUri is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sderefUri>%s</%sderefUri>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.derefUri), input_name='derefUri')), namespace_, eol_))
        if self.digest is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdigest>%s</%sdigest>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.digest), input_name='digest')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class area(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='cap:', name_='area', fromsubclass_=False, pretty_print=True):
        ...
        if self.areaDesc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sareaDesc>%s</%sareaDesc>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.areaDesc), input_name='areaDesc')), namespace_, eol_))
        for polygon_ in self.polygon:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%spolygon>%s</%spolygon>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(polygon_), input_name='polygon')), namespace_, eol_))
        for circle_ in self.circle:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scircle>%s</%scircle>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(circle_), input_name='circle')), namespace_, eol_))
...
class geocode(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, geocode)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if geocode.subclass:
    ...
    def export(self, outfile, level, namespace_='cap:', name_='geocode', namespacedef_='xmlns:cap="urn:oasis:names:tc:emergency:cap:1.2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('geocode')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from cap_api import *\n\n')
        sys.stdout.write('import cap_api as model_\n\n')
